 ...
 */
abstract class GroupMediaAccessTestBase extends EntityKernelTestBase {
   ...
   * @var array
   */
  public static $modules = ['group', 'media', 'gmedia'];
  ...
  protected function setUp() {
    ...
    $storage->createFromPlugin($this->groupTypeA, 'group_media:b')->save();
    $storage->createFromPlugin($this->groupTypeB, 'group_media:b')->save();

    // Set group_media permissions on the group types.
    $member_a = [
      'view group_media:a entity',
      'view group_media:b entity',
      'view unpublished group_media:a entity',
      'update own group_media:a entity',
      'delete own group_media:a entity',
    ];
    $member_b = [
      'update any group_media:b entity',
      'delete any group_media:b entity',
    ];
    $outsider_a = [
      'view group_media:a entity',
      'view group_media:b entity',
    ...
    $outsider_b = [
      'view group_media:b entity',
      'update own group_media:b entity',
      'delete own group_media:b entity',
    ];
    $anonymous_a = [
      'view group_media:a entity',
    ];
