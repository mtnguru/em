...
/**
 * Validates the LinkVisible constraint.
 */
class LinkVisibleConstraintValidator extends ConstraintValidator implements ContainerInjectionInterface {
  ...
  /**
   * Constructs a new LinkVisibleConstraintValidator.
   *
